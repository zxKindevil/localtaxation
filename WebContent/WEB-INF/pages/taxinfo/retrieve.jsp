...
<body>
	<% //TODO tax retrieve dosn't complete %>
	<h2>税务信息查询</h2>
	<div style="padding:5px;margin:5px;border:1px solid #AFEEEE">
		<form id="sform" action="<%= url %>/pbt/retrieve" method="post">
	    	<table cellpadding="5">
	    		<tr>
	    			<td>房产ID：</td>
	    			<td><input name="p_property_id" class="easyui-textbox" type="text" ></input></td>
	    			<td style="width:40px"></td>
	    			<td>路段：</td>
	    			<td><input name="p_street" class="easyui-textbox" type="text" ></input></td>
	    			<td style="width:40px"></td>
	    			<td>产权人：</td>
	    			<td><input name="p_property_owner" class="easyui-textbox" type="text" ></input></td>
	    			<td style="width:40px"></td>
	    			<td>产权人身份证：</td>
	    			<td><input name="p_property_owner_idcard" class="easyui-textbox" type="text" ></input></td>
	    		</tr>
	    		
	    		<tr>
	    			<td>税务年度：</td>
	    			<td><input name="t_tax_year" class="easyui-textbox" type="text" ></input></td>
	    			<td style="width:40px"></td>
	    			<% //TODO 税务查询 是否缴纳 xml中isEqual问题  %>
	    			<td>是否缴纳完税款：</td>
	    			<td>
						<select name="arg_isPaid" style="width:60px"  panelHeight="auto" class="easyui-combobox" >
	    					<option value=""></option>
	    			...
	    			<td>是否审核：</td>
	    			<td>
						<select name="arg_isChecked" style="width:60px"  panelHeight="auto" class="easyui-combobox" >
	    					<option value=""></option>
	    					<option value="是">是</option>
	    					<option value="否">否</option>
	    				</select>
	...
	<div style="margin:5px;">
		...
		<c:forEach var="var" items="${ pbt_list }" >
			<tr>
